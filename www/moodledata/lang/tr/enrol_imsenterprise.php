...
/**
 * Strings for component 'enrol_imsenterprise', language 'tr', version '4.3'.
 *
...
$string['allowunenrol_desc'] = 'Etkinleştirilirse, Enterprise verisinde belirtildiğinde ders kayıtları kaldırılır.';
...
$string['createnewcategories'] = 'Moodle\'da yok ise yeni (gizli) ders kategorilerini oluştur';
...
$string['settingshortnamedescription'] = 'Kısa adı zorunlu bir ders alanı olduğundan, seçilen açıklama etiketini IMS Enterprise dosyanızda tanımlamanız gerekir';
...
$string['truncatecoursecodes_desc'] = 'Bazı durumlarda, işleme başlamadan önce belirli bir uzunlukta kesmek istediğiniz ders kodunuz olabilir. Öyleyse, bu kutuya karakter sayısını girin. Aksi takdirde, kutuyu boş bırakın ve kesme meydana gelmez.';
...
$string['updatecourses_desc'] = 'Etkinleştirilirse, IMS Enterprise kayıt eklentisi ders tam ve kısa adlarını güncelleyebilir ("recstatus" bayrağı bir güncelleme temsil eden 2 olarak ayarlanırsa).';
