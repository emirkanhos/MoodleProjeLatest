...
$string['courseidnumbertaken'] = 'ID numarası başka bir ders için kullanılıyor ({$a})';
$string['coursemisconf'] = 'Kurs yanlış yapılandırılmış';
$string['courserequestdisabled'] = 'Üzgünüz, ders istekleri yönetici tarafından devre dışı bırakıldı.';
...
$string['nostartdatenoenddate'] = 'Bir ders bitiş tarihi ancak bir başlangıç tarihi de ayarlanmışsa ayarlanabilir.';
...
$string['shortnametaken'] = 'Kısa ad başka bir ders ({$a}) için zaten kullanılmış';
...
$string['unknowncourseidnumber'] = 'Bilinmeyen ders ID "{$a}"';
$string['unknowncourserequest'] = 'Hatalı ders isteği';
$string['unknowncoursesection'] = '"{$a}" dersi içinde bilinmeyen ders bölümü';
