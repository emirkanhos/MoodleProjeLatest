...
/**
 * Strings for component 'tool_mfa', language 'tr', version '4.3'.
 *
 * @package     tool_mfa
 * @category    string
...
$string['areyousure'] = 'Faktörü iptal etmek istediğinize emin misiniz?';
...
$string['error:revoke'] = 'Faktörü iptal edemiyor';
...
$string['revokefactor'] = 'Faktörü iptal et';
...
$string['verificationcode'] = 'Kodu gir';
