...
/**
 * Strings for component 'enrol_ldap', language 'tr', version '4.3'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['assignrole'] = 'Rol atama \'{$a->role_shortname}\' kullanıcısına \'{$a->user_username}\' ders \'{$a->course_shortname}\' (id {$a->course_id})';
...
$string['courseupdateskipped'] = 'Ad numarası \'{$a->idnumber}\' olan ders başarıyla güncellendi. Atlama...';
$string['createcourseextid'] = 'OLUŞTUR Var olmayan bir derse kaydolan kullanıcı\' {$a->courseextid}\'';
