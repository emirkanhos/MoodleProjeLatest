...
/**
 * Strings for component 'forum', language 'tr', version '4.3'.
 *
 * @package     forum
 * @category    string
...
$string['cannotcreateinstanceforteacher'] = 'Öğretmen forumu için yeni ders modülü örneği oluşturulamadı';
...
$string['cutoffdatereached'] = 'Bu foruma kayıt göndermek için kesme tarihine ulaşıldığından artık foruma mesaj gönderemezsiniz.';
...
$string['duedate_help'] = 'Bu, foruma mesaj göndermenin zamanıdır. Bu tarih, takvimde forum için son tarih olarak gösterilse de, bu tarihten sonra yayınlamaya yine de izin verilecektir. Belirli bir tarihten sonra foruma mesaj göndermeyi önlemek için forumun bitiş tarihi belirleyin.';
...
$string['forum:canoverridecutoff'] = 'Son tarihlerinden sonra forumlarda yayınlayın';
...
$string['modulename_help'] = 'Forum etkinliği modülü, katılımcıların asenkron tartışmalara, yani uzun bir süre boyunca gerçekleşen tartışmalara olanak tanır.
...
Katılımcılar, yeni forum yayınlarının bildirimlerini almak için bir foruma abone olabilir. Bir öğretmen, abonelik modunu isteğe bağlı, zorunlu veya otomatik olarak ayarlayabilir veya aboneliği tamamen engelleyebilir. Gerekli görüldüğünde, öğrencilerin belirli bir süre içinde belirli sayıda yayın göndermesine izin verilmeyebilir; Bu bireylerin tartışmalara hakim olmasını önleyebilir.
...
Forumların birçok kullanımı var
* Öğrencilerin birbirlerini tanıması için bir sosyal alan
...
* Kapsamlı etkinlikler için, örneğin öğrencilerin üzerinde düşünmeleri ve çözüm önerileri getirmeleri için \'zeka soruları\'';
...
$string['postmailinfolink'] = 'Bu, {$a->coursename} adresine gönderilen bir mesajın bir kopyasıdır.
Yanıtlamak için şu bağlantıyı tıklayın: {$a->replylink}';
...
$string['postrating1'] = 'Çoğunlukla ayrık bilgi';
$string['postrating2'] = 'Ayrık ve bağlantılı';
$string['postrating3'] = 'Çoğunlukla bağlantılı bilgi';
$string['posts'] = 'Mesajlar';
$string['postsfrom'] = 'Tarafından gönderilen yayınlar';
...
$string['privacy:metadata:core_rating'] = 'Forum, gönderilerin derecelendirilmesini desteklemek için derecelendirme alt sistemini kullanır.';
...
$string['removeallforumtags'] = 'Tüm forum etiketlerini kaldır';
...
$string['resetdigests'] = 'Kullanıcı başına forum özet tercihlerini sil';
...
$string['rssarticles_help'] = '<p>Bu seçenek size RSS içeriğindeki madde sayısını seçmenize olanak sağlar.</p>
<p>Çoğu forum için 5 ile 20 arası yeterlidir. Forum çok kullanışlıysa sayıyı arttırabilirsiniz.</p>';
