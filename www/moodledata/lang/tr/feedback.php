...
/**
 * Strings for component 'feedback', language 'tr', version '4.3'.
 *
 * @package     feedback
 * @category    string
...
$string['modulenameplural'] = 'Anket (Ger ibildirim)';
...
$string['multiplesubmit_help'] = 'Anonim anketler için etkinleştirilirse, kullanıcılar sınırsız sayıda geribildirim gönderebilir.';
$string['name'] = 'Ad';
...
$string['resetting_data'] = 'Geri bildirim yanıtlarını temizle';
...
$string['url_for_continue_help'] = 'Geri bildirim gönderdikten sonra, ders sayfasına yönlendiren bir devam düğmesi görüntülenir. Alternatif olarak, etkinliğin URL\'si buraya girilirse bir sonraki etkinliğe bağlanabilir.';
