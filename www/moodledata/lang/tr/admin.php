...
$string['allowcohortthemes'] = 'Grup temalarına izin ver';
...
$string['configallowobjectembed'] = 'Öntanımlı bir güvenlik ölçütü olarak, normal kullanıcıların, html içerisinde EMBED ve OBJECT etiketleri kullanarak metinlerin içerisine multimedia dosyaları gömmesine (mediapluginleri yardımıyla güvenli şekilde yapılabilmesine karşın) izin verilmez.  Eğer bu etiketlere izin vermek isterseniz bu seçeneği etkinleştirin.';
...
$string['configmaxusersperpage'] = 'Kullanıcı seçici ile görüntülenebilecek maximum kullanıcı sayısı';
...
$string['coursecolorheading_desc'] = 'Kurs ayarlarında kurs görüntüsü bulunmayan kurslar, Kontrol Panelinde desenli kurs kartıyla görüntülenir. Desende kullanılan renkler aşağıda belirtilebilir.';
...
$string['courselistshortnames_desc'] = 'Etkinleştirilirse, kurs listelerindeki tam adlara ek olarak kurs kısa adları görüntülenir. Gerekirse, genişletilmiş ders adları, dil özelleştirme özelliğini kullanarak \'courseextendednamedisplay\' dil dizilimini düzenleyerek özelleştirilebilir.';
...
$string['courserequestnotifyemail'] = '{$a->user} <a href="{$a->link}">{$a->link}</a>de yeni bir kurs istedi';
...
$string['legacyfilesaddallowed_help'] = 'Bir kurs, eski ders dosyalarına sahipse, yeni dosya ve klasörlerin eklenmesine izin verin.';
...
$string['profilingslow'] = 'Profil yavaş sayfaları';
...
$string['quizattemptsupgradedmessage'] = 'Moodle 2.1 sürümünde sorularla ilgili büyük bir sürüm güncelemesi yapıldı. Veritabanın bir kısımının daha sonra güncellemek üzere geriye bırakmak mümkün oldu. Moodle 2.8\'e yükseltmeden önce, bu güncellemenin tamamlanması gerekir.';
...
$string['taskcompletiondaily'] = 'Başlama tamamlanma işareti';
...
$string['testsiteupgradewarning'] = 'Şu anda {$} test sitesi kullanıyorsunuz, düzgün yüksetlme yapabilmek için komut satırı arabirimi aracını kullanın.';
...
$string['userfeedbackencouragement'] = '<p>Moodle 3.9\'dan itibaren, kullanıcılara Moodle HQ tarafından barındırılan harici bir anket sitesi aracılığıyla Moodle HQ\'ya Moodle yazılımı hakkında geri bildirim sağlama seçeneği sunan yeni bir özellik dahil edilmiştir. Anket sitesine hiçbir kullanıcı tanımlayıcı bilgi gönderilmez.</p>
<p>Moodle HQ, veri toplama uygulamaları konusunda açık ve şeffaf olmaya çalışmaktadır. Bu nedenle, bu işlevselliğin farkında ve kontrolünün sizde olduğundan emin olmak istiyoruz.</p>
<p>Kullanıcılardan gelen geri bildirimler, Moodle HQ\'nun Moodle yazılımını iyileştirmesine büyük ölçüde yardımcı olacaktır. Bu özelliği etkinleştirmek için lütfen <a href="{$a}">Geri bildirim ayarlarına</a> gidin.</p>';
