...
/**
 * Strings for component 'assign', language 'tr', version '4.3'.
 *
 * @package     assign
 * @category    string
...
$string['attemptreopenmethod'] = 'Ek denemeler';
$string['attemptreopenmethod_help'] = 'Bu ayar, bir öğrencinin ödevde ek denemeler yapıp yapamayacağını belirler. Her deneme için not ve geri bildirim kaydedilir ve öğretmen ve öğrenci tarafından görüntülenebilir. Mevcut seçenekler şunlardır:

* Asla - Yalnızca bir deneme mümkündür.
* Elle - Bir öğretmen ek denemelere izin verebilir.
* Başarılı oluncaya kadar otomatik olarak - Öğrenci, bu ödev için not defterinde belirlenen notu geçene kadar ek denemelere otomatik olarak izin verilir.';
...
$string['blindmarkingenabledwarning'] = 'Bu etkinlik için isimsiz gönderimler etkinleştirilir. Notlar, not verme işlem menüsü aracılığıyla öğrenci kimlikleri ortaya çıkana kadar not defterine eklenmeyecektir.';
...
$string['cutoffdatevalidation'] = 'Hesap kesim tarihi, vade tarihinden önce olamaz.';
...
$string['duedate_help'] = 'Bu, görevin bitiş tarihidir. Gönderimlere bu tarihten sonra da izin verilecektir, ancak bu tarihten sonra gönderilen ödevler geç kaldı olarak değerlendirilecektir. Belirli bir tarihten sonra gönderimleri önlemek için bir ödev bitiş tarihi belirleyin.';
