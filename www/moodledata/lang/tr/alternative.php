...
/**
 * Strings for component 'alternative', language 'tr', version '4.3'.
 *
 * @package     alternative
 * @category    string
...
$string['groupdependent_help'] = 'Bu kutu işaretlenirse, her kullanıcıya gösterilen metin, grubuna bağlı olacaktır.';
