...
/**
 * Strings for component 'qtype_essayautograde', language 'tr', version '4.3'.
 *
...
$string['bandcount'] = 'İçin';
$string['bandpercent'] = 'veya daha fazla öge, ödül';
...
$string['percentofquestiongrade'] = 'Soru notunun %{$a} kadarı.';
