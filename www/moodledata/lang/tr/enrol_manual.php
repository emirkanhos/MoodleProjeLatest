...
/**
 * Strings for component 'enrol_manual', language 'tr', version '4.3'.
 *
...
$string['expiredaction_help'] = 'Kullanıcı kaydı sona erdiğinde gerçekleştirilecek işlemi seçin. Bazı kullanıcı verilerinin ve ayarların ders boyunca derse kayıtlı olmayan kulanıcıların temizlendiğini lütfen unutmayın';
...
$string['pluginname_desc'] = 'El ile kayıt eklentisi, bir öğretmen gibi uygun izinlere sahip bir kullanıcı tarafından ders yönetimi ayarlarındaki bir bağlantı yoluyla kullanıcıların elle kayıt edilmesini sağlar. Kendi kayıt gibi bazı diğer kayıt eklentileri gerektirdiğinden, eklenti normal olarak etkinleştirilmelidir.';
...
$string['status_desc'] = 'Dahili olarak kayıtlı olan kullanıcıların ders erişimine izin verin. Çoğu durumda bu muhafaza edilmelidir.';
$string['status_help'] = 'Bu ayar, kullanıcıların ders yönetimi ayarlarındaki bir bağlantı yoluyla, öğretmen gibi uygun izinlere sahip bir kullanıcı tarafından el ile kaydedilip kaydedilmeyeceğini belirler.';
...
$string['wscannotenrol'] = 'Eklenti örneği bir kullanıcıyı ders kimlik numarasına el ile kaydedemez  id= {$a->courseid}';
$string['wsnoinstance'] = 'El ile kayıt eklentisi örneği mevcut değil veya ders için devre dışı bırakıldı  (id = {$a->courseid})';
