...
/**
 * Strings for component 'resource', language 'tr', version '4.3'.
 *
 * @package     resource
 * @category    string
...
$string['modulename_help'] = 'Kurs modülü, bir öğretmenin bir kurs kaynağı olarak bir dosya sağlamasına olanak tanır. Mümkün olduğunda, dosya ders arabirimi içerisinde görüntülenir; Aksi takdirde öğrencilerden indirmeleri istenecektir. Dosya, destekleyici dosyaları içerebilir, ör. HTML sayfası gömülü görüntülere sahip olabilir.
