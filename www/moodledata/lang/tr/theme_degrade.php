...
$string['logowhite_desc'] = 'Siyah beyaz üst logo.  Bu görüntü, kaydırma olmadığında renkli arka planla kullanılacaktır.  Desteklenen formatlar: GIF, PNG, JPG ve SVG';
