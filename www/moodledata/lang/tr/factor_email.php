...
/**
 * Strings for component 'factor_email', language 'tr', version '4.3'.
 *
...
$string['email:revokesuccess'] = 'Bu kod başarıyla iptal edildi. {$a} için tüm oturumlar sonlandırıldı.
...
$string['info'] = 'Yerleşik faktör. Kullanıcının e-postasına bir doğrulama kodu gönderilir.';
...
$string['setupfactor'] = 'E-posta faktörü kurulumu';
