...
/**
 * Strings for component 'folder', language 'tr', version '4.3'.
 *
 * @package     folder
 * @category    string
...
$string['displayinline'] = 'Bir ders sayfasında satır içi';
...
$string['modulename_help'] = 'Klasör modülü, bir öğretmenin bir tek klasör içerisinde birkaç ilgili dosyayı görüntülemesini sağlar, böylece ders sayfasındaki kaydırma işlemi azaltılır. Sıkıştırılmış bir klasöre görüntü için yüklenebilir veya sıkıştırılmış olabilir, boş bir klasör oluşturulmuş ve içine dosyalar yüklenmiş olabilir.

Bir klasör kullanılabilir
