...
/**
 * Strings for component 'plagiarism_turnitin', language 'tr', version '4.3'.
 *
...
$string['genimmediately2'] = 'Raporları hemen oluşturun (öğrenciler son teslim tarihine kadar yeniden gönderebilir): $a->num_resubmissions} yeniden gönderiminden sonra, raporlar {$a->num_hours} saat sonra oluşturulur';
