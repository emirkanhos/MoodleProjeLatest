...
/**
 * Strings for component 'tool_generator', language 'tr', version '4.3'.
 *
...
$string['coursewithoutusers'] = 'Seçilen dersin kullanıcısı yok';
...
$string['error_noforumdiscussions'] = 'Seçilen ders forum tartışmaları içermiyor';
$string['error_noforuminstances'] = 'Seçilen ders forum modülü örneklerini içermiyor';
$string['error_noforumreplies'] = 'Seçilen ders forum cevaplarını içermiyor';
$string['error_nonexistingcourse'] = 'Belirtilen ders mevcut değil';
$string['error_nopageinstances'] = 'Seçilen ders sayfa modülü örneklerini içermiyor';
...
$string['updateuserspassword_help'] = 'JMeter\'in ders kullanıcıları olarak giriş yapması gerekir; config.php dosyasında $CFG->tool_generator_users_password kullanılarak kullanıcı şifresini ayarlayabilirsiniz; Bu ayar, kurs kullanıcısının parolasını $CFG->tool_generator_users_password değerine göre güncelleştirir. Bu, tool_generator tarafından oluşturulmayan bir dersi kullanıyorsanız veya test kursları oluştururken $CFG->tool_generator_users_password ayarlanmadığında yararlı olabilir.';
