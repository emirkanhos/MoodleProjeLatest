...
/**
 * Strings for component 'question', language 'tr', version '4.3'.
 *
 * @package     question
 * @category    string
...
$string['cannotgetdsforquestion'] = 'Hesaplanmış soru için belirtilen veri kümesi alınamıyor!  (question: {$a})';
...
$string['importfromcoursefiles'] = '... ya da aktarım için bir ders dosyası seçin.';
...
$string['page-question-x'] = 'Tüm soru sayfaları';
$string['parent'] = 'Ana';
...
$string['questionsinuse'] = '* Kullanımda oldukları için silinemeyen soruları belirtir. Bunun yerine, \'Eski soruları göster\' seçeneğini seçmediğiniz sürece soru bankasında gizleneceklerdir.';
...
$string['showquestiontext'] = 'Soru listesinde soru metnini gösterilecek mi';
