...
/**
 * Strings for component 'qtype_calculated', language 'tr', version '4.3'.
 *
...
$string['correctfeedback'] = 'Herhangi bir doğru tepki için';
...
$string['editdatasets_link'] = 'soru/tür/hesaplanmış';
$string['existingcategory1'] = 'hali hazırda var olan ve paylaşılan bir veri kümesini kullanacaktır';
$string['existingcategory2'] = 'bu kategorideki diğer sorular tarafından da kullanılan mevcut bir dosya grubundan bir dosya';
...
$string['functiontakesatleasttwo'] = 'Fonksiyon {$a} en az iki argüman olmalıdır';
$string['functiontakesnoargs'] = 'Fonksiyon {$a} herhangi bir argüman almaz';
$string['functiontakesonearg'] = 'Fonksiyon {$a} tam bir argüman olmalıdır';
$string['functiontakesoneortwoargs'] = 'Fonksiyon {$a} bir veya iki argüman olmalıdır';
...
$string['mustenteraformulaorstar'] = 'Bir formül girmelisiniz veya \'*\'.';
...
$string['pluginname_link'] = 'soru/tür/hesaplanmış';
$string['pluginnameadding'] = 'Hesaplanmış soru ekleniyor';
$string['pluginnameediting'] = 'Hesaplanmış soru düzenleniyor';
$string['pluginnamesummary'] = 'Hesaplanmış sorular sayısal sorular gibidir, ancak kullanılan sayılar sınav yapılırken bir kümeden rastgele seçilir.';
...
$string['replacewithrandom'] = 'Rastgele bir değere değiştirin';
