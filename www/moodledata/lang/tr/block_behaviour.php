...
/**
 * Strings for component 'block_behaviour', language 'tr', version '4.3'.
 *
...
$string['adminheaderstudyid'] = 'Öğrenci çalışma kimliğini gösterme veya gizleme';
$string['adminheaderuselord'] = 'LORD eklentisi ile entegre edin';
$string['adminuselorddesc'] = 'Bu, öğretmenlere Learning Object Relationship Discovery (LORD) blok eklentisinden learning object grafiğini alma seçeneği sunacaktır.';
$string['adminuselordlabel'] = 'Lord\'un grafiğini kullanmama izin verir misin?';
...
$string['privacy:metadata:block_behaviour:uselord'] = 'Grafiği LORD eklentisinden kullanıp kullanmamak için işaretleyin.';
...
$string['runkmeans'] = 'k-meansı çalıştır';
$string['save'] = 'Kaydet';
...
$string['shownameslabel'] = 'Öğrenci isimlerini göstermek mi?';
...
$string['totalmeasures'] = 'Toplam önlemler';
$string['update'] = 'Davranış Analitiğini Güncelle';
$string['uselordcustomdesc'] = 'Bu, manipüle edilmiş LORD grafiğini kullanacaktır.  Aksi takdirde sistem tarafından oluşturulan grafik kullanılacaktır.';
$string['uselordcustomlabel'] = 'Manipüle edilmiş LORD grafiğini mi kullanıyorsunuz?';
$string['uselorddesc'] = 'Bu, Öğrenme Nesnesi İlişkisi Keşfi (LORD) blok eklentisinden öğrenme nesnesi grafiğini alacaktır.';
$string['uselordlabel'] = 'LORD\'un grafiğini kullan?';
