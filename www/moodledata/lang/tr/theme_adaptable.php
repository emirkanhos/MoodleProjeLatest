...
/**
 * Strings for component 'theme_adaptable', language 'tr', version '4.3'.
 *
...
$string['breadcrumbseparatordesc'] = 'Hesapta öğe ayırıcı olarak kullanılmak üzere <a href="https://fortawesome.github.io/Font-Awesome/icons/" target="_blank"> Yazı Tipi Harika Simgesi </a> \'ni ayarlayın. önek olmadan simge adını girin.';
...
$string['buttonfocuscolor'] = 'Odak düğmesi rengi';
$string['buttonfocuscoloropacity'] = 'Düğme odak rengi opaklığı';
$string['buttonhovercolor'] = 'Düğme arkaplanın vurgu rengi';
$string['buttonhovercolorcancel'] = 'Düğme vurgulu rengini iptal et';
$string['buttonhovercolordesc'] = 'Düğmenin üzerine gelindiğinde düğmenin değiştiği renk.';
...
$string['courseindexsettings'] = 'Renk İndexi';
...
$string['menuhovercolor'] = 'Ana menü vurgulama rengi';
...
$string['navbardisplaysubmenuarrowdesc'] = 'Bir menü başlığında alt menü seçenekleri olduğunda alt menü okunu (aşağı bakan) görüntüleyin.';
...
$string['versionstable'] = 'Kararlı sürüm - Evrende hepsini bulmak için yeterli zaman kalmadığından hatalar içerebilir.  Üretim sunucunuza yüklemeden önce bir test sunucusunda kontrol edin, bunu ciddi olarak yapın!  Pişman olmayacaksınız ve memnun kalana kadar kişiselleştirebilecek, ardından ayar değerlerini aktarmak ve dosyaları engellemek için \'Ayarları içe / dışa aktar\' işlevini kullanabileceksiniz.';
