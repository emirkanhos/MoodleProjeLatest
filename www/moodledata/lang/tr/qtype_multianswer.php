...
/**
 * Strings for component 'qtype_multianswer', language 'tr', version '4.3'.
 *
...
$string['invalidmultianswerquestion'] = 'Geçersiz gömülü cevaplar (Cloze) sorusu ({$a}).';
$string['layout'] = 'Görünüm';
$string['layouthorizontal'] = 'Radyo düğmelerinin yatay sırası';
$string['layoutmultiple_horizontal'] = 'Yatay satır kutusu işaret kutuları';
$string['layoutmultiple_vertical'] = 'Onay kutularının dikey sütunları';
...
$string['pluginname'] = 'Tümleşik cevaplar (Cloze)';
$string['pluginname_help'] = 'Tümleşik cevap (Cloze) soruları, içinde çoktan seçmeli ve kısa cevap gibi soruların bulunduğu bir metinden oluşur.';
$string['pluginname_link'] = 'question/type/multianswer';
$string['pluginnameadding'] = 'Tümleşik cevap (Cloze)';
$string['pluginnameediting'] = 'Tümleşik cevapar (Cloze) düzenleniyor';
...
$string['privacy:metadata'] = 'Gömülü cevaplar (Cloze) soru tipi eklentisi herhangi bir kişisel veri saklamaz.';
