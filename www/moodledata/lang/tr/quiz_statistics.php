...
/**
 * Strings for component 'quiz_statistics', language 'tr', version '4.3'.
 *
...
$string['actualresponse'] = 'Gerçek yanıt';
...
$string['calculatingallstats'] = 'Test, soru ve yanıt verilerini analiz etmek için istatistikleri hesaplanıyor';
...
$string['discrimination_index'] = 'Ayırıcı index';
$string['discriminative_efficiency'] = 'Ayırt edicilik gücü';
$string['downloadeverything'] = 'Raporu şu formatta:';
...
$string['facility'] = 'Zorluk indeksi';
...
$string['getstatslocktimeoutdesc'] = 'Bir test için istatistik hesaplaması yapılmaya çalışıldığında kilit için kaç saniye bekleneceği. Bu ayar öncelikle test için vardır, ne yaptığınızı bilmiyorsanız değiştirmeyin.';
$string['highestattempts'] = 'en yuksek puanlı uyguyalama';
...
$string['negcovar'] = 'Toplam deneme derecesine sahip notun negatif ortakdeğişkesi';
