...
/**
 * Strings for component 'moodle', language 'tr', version '4.3'.
 *
 * @package     moodle
 * @category    string
...
$string['courseenddateenabled_desc'] = 'Bu ayar, ders bitiş tarihinin varsayılan olarak yeni kurslar için etkinleştirilip etkinleştirilmeyeceğini ve belirlenen tarihin kurs süresine göre hesaplanıp, hesaplanmayacağını belirler.';
...
$string['coursehelpforce'] = 'Kursdaki her etkinlik için ders grup modunu zorunlu kıl.';
...
$string['coursehelpnumberweeks'] = 'Kursdaki bölüm sayısı (sadece belirli ders formatları için geçerlidir).';
...
$string['deleteallratings'] = 'Tüm puanları sil';
...
$string['emailconfirmation'] = 'Merhaba,
...
$string['format'] = 'Biçim';
$string['format_help'] = 'Kurs formatı, kurs sayfasının yerleşim düzenini belirler.
 * Tek etkinlik biçimi- Kurs sayfasında tek etkinliği veya kaynağı (örneğin Sınav veya SCORM paketi) görüntülenmesi içindir.
 * Sosyal Biçim - Kurs sayfasında bir forum görüntülenir.
 * Konu Biçimi - Kurs sayfasında bölümler konular halinde düzenlenir.
 * Haftalık Biçim - Kurs ilk haftasının başlangıcını dersin başlangıç tarihi olarak alan ve konuların haftalık olarak gösterildiği ders biçimidir.';
...
$string['indicator:accessesafterend_help'] = 'Bu gösterge, öğrencinin derse ders bitiş tarihinden sonra erişip erişmediğini gösterir.';
...
$string['indicator:anycourseaccess'] = 'Herhangi bir ders girişi';
$string['indicator:anycourseaccess_help'] = 'Bu gösterge, kullanıcının kayıtlı olduğu herhangi bir derse erişimi yansıtır.';
...
$string['indicator:anywriteincourse_help'] = 'Bu gösterge, herhangi bir ders etkinliğinde öğrenci tarafından gerçekleştirilen herhangi bir yazma (gönderme) eylemini temsil eder.';
...
$string['indicator:potentialcognitive_help'] = 'Bu gösterge, ders etkinliklerine katılan bir öğrencinin ulaşabileceği potansiyel bilişsel derinliğe dayanmaktadır.';
...
$string['indicator:potentialsocial_help'] = 'Bu gösterge, ders etkinliklerine katılan öğrencinin ulaşabileceği potansiyel sosyal genişliğe dayanmaktadır.';
...
$string['paymentsorry'] = 'Ödemeniz için teşekkürler! Ancak ödemeniz tam olarak işleme alınmadı ve "{$a->fullname}" dersine girmek için henüz kaydedilmediniz. Lütfen bir kaç dakika sonra derse girmeyi tekrar deneyin. Kursa girerken hala sorun yaşıyorsanız site yöneticini veya {$a->teacher} \'i uyarınız.';
...
$string['relativedatesmode_warning'] = '<strong> Uyarı: </strong> Göreceli tarihler modu, ders oluşturulduktan sonra değiştirilemez.';
...
$string['scalestip2'] = 'Özel ölçekler oluşturmak için ders yönetim menüsünde Notlar bağlantısını tıklayıp Ölçekleri Düzenle\'yi seçin.';
...
$string['showgrades_help'] = 'Kursdaki bir çok etkinlik not ayarlanabilir. Bu ayarla öğrencinin ders yönetim bloğundaki bir bağlantı yoluyla dersteki notların listesini görüp göremeyeceği belirlenir.';
$string['showingacourses'] = 'Tüm {$a} kursları göster';
$string['showingxofycourses'] = 'Toplam {$a->total} ders içerisinde, başlangıç {$a->start} ile bitiş {$a->end} kursgörüntüleniyor';
...
$string['statsnodatauser'] = 'Bu kurs, kullanıcı ve zaman periyodu kombinasyonu için mevcut veri yok.';
...
$string['welcometocoursetext'] = '{$a->coursename} hoş geldiniz!
