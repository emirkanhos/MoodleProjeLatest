...
/**
 * Strings for component 'enrol_self', language 'tr', version '4.3'.
 *
 * @package     enrol_self
 * @category    string
...
$string['customwelcomemessage_help'] = 'Özel bir hoş geldiniz mesajı, HTML etiketleri ve çoklu dil etiketlerini de içeren düz metin veya Moodle-otomatik format olarak eklenebilir.

Aşağıdaki yer tutucuları iletiye dahil edilebilir:
...
$string['expiredaction_help'] = 'Kullanıcı kaydı sona erdiğinde gerçekleştirilecek işlemi seçin. Bazı kullanıcı verilerinin ve ayarlarının ders boyunca derese kaydedilmeyeceğini lütfen unutmayın.';
...
$string['password_help'] = 'Bir kayıt anahtarı, ders yalnızca anahtarı bilen kişilerle sınırlandırılmasını sağlar.

Alan boş bırakılırsa, herhangi bir kullanıcı derste kayıt olabilir.

Bir kayıt anahtarı belirtilirse, derste kayıt olmaya çalışan herhangi bir kullanıcının anahtarı sağlamanız gerekecektir. Bir kullanıcının kayıt grubuna kaydolurken yalnızca bir kayıt anahtarı sağlamanız gerektiğini unutmayın.';
...
$string['sendcoursewelcomemessage_help'] = 'Bir kullanıcı kendi dersine girdiğinde, bir karşılama mesajı e-postası gönderilebilir. Eğer ders sorumlusundan (varsayılan olarak öğretmen) gönderilirse ve birden fazla kullanıcı bu role sahipse, e-posta rolü atanacak ilk kullanıcıdan gönderilir.';
