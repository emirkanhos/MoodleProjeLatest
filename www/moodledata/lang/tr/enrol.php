...
/**
 * Strings for component 'enrol', language 'tr', version '4.3'.
 *
 * @package     enrol
 * @category    string
...
$string['eventuserenrolmentdeleted'] = 'Kullanıcı ders kaydını sildi';
...
$string['extremovedaction_help'] = 'Kullanıcı kaydı dış kayıt kaynağından kaybolduğunda gerçekleştirilecek işlemi seçin. Bazı kullanıcı verilerinin ve ayarlarının ders elden çıkarma sırasında elden çıkarıldığını lütfen unutmayın.';
...
$string['proceedtocourse'] = 'Kurs içeriğine devam et';
