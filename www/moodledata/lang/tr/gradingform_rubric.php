...
/**
 * Strings for component 'gradingform_rubric', language 'tr', version '4.3'.
 *
...
$string['privacy:metadata:criterionid'] = 'Derecelendirilen belirli bir kriter için bir tanımlayıcı.';
