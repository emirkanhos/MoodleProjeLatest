...
/**
 * Strings for component 'badges', language 'tr', version '4.3'.
 *
 * @package     badges
 * @category    string
...
$string['activatesuccess'] = 'Rozetlere erişim başarıyla etkinleştirildi.';
...
$string['addcohort'] = 'Grup ekle';
$string['addcohort_help'] = 'Bu rozet gereksinimine eklenmesi gereken tüm grupları seçin. Birden çok öğe seçmek için CTRL tuşunu basılı tutun.';
...
$string['deactivatesuccess'] = 'Rozetlere erişim devre dışı bırakıldı';
