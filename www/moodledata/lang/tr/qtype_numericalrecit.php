...
/**
 * Strings for component 'qtype_numericalrecit', language 'tr', version '4.3'.
 *
...
$string['answermark_help'] = '**Gerekli**.
 0\'dan büyük bir sayı olması gereken bu bölümün cevabının değeri.
  Tüm sorunun varsayılan değeri, tüm bölüm puanlarının toplamıdır.

 Not: Bu kısmın değerlendirme alanı boş bırakılırsa soru kaydedildiğinde kısım silinecektir.<br>
