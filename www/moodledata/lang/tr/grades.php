...
$string['exportas'] = 'Şu olark dışa aktar';
...
$string['linktoactivity'] = '{$a->name} etkinliğine bağlantı {$a->title}';
$string['lock'] = 'Kilitle';
...
$string['modgradecategoryrescalegrades_help'] = 'Bir not defteri öğesinde en yüksek notları değiştirirken bunun mevcut yüzdelik notların da değişmesine neden olup olmayacağını belirtmeniz gerekir.Bu \'Evet\' olarak ayarlanırsa, geçersiz kılınmış mevcut notların yüzdesi aynı kalacak şekilde tekrar ölçeklendirilir. Örneğin, bu seçenek \'Evet\' olarak ayarlanırsa bir öğedeki maksimum notun 10\'dan 20\'ye değiştirilmesi, 6/10 (% 60) derecesinin 12/20 (% 60) olarak yeniden ölçeklenmesine neden olur.  Bu seçenek \'Hayır\' olarak ayarlandığında, not değişmeden kalır ve doğru puanları elde etmek için not öğelerinin manuel olarak ayarlanmasını gerektirir..';
...
$string['modgraderescalegrades_help'] = 'Bir not defteri öğesinde en yüksek notları değiştirirken bunun mevcut yüzdelik notların da değişmesine neden olup olmayacağını belirtmeniz gerekir.Bu \'Evet\' olarak ayarlanırsa, geçersiz kılınmış mevcut notların yüzdesi aynı kalacak şekilde tekrar ölçeklendirilir. Örneğin, bu seçenek \'Evet\' olarak ayarlanırsa bir öğedeki maksimum notun 10\'dan 20\'ye değiştirilmesi, 6/10 (% 60) derecesinin 12/20 (% 60) olarak yeniden ölçeklenmesine neden olur.  Bu seçenek \'Hayır\' olarak ayarlandığında, not değişmeden kalır ve doğru puanları elde etmek için not öğelerinin manuel olarak ayarlanmasını gerektirir..';
...
$string['noscales'] = 'Kazanımlar bir ders ölçeğine ya da genel ölçeğe bağlı olmalıdır, ancak mevcutta hiç yok. Bir tane eklemek ister misiniz?';
