...
/**
 * Strings for component 'tool_uploaduser', language 'tr', version '4.3'.
 *
...
$string['invaliduserdatavalues'] = 'Otomatik olarak temizlenen \'{$a->username}\' ({$a->values}) kullanıcısı için geçersiz veri algılandı.';
$string['linex'] = 'Line {$a}';
